package no.novari.fint.sikri.utilities;

public enum SikriObjectTypes {
    ...
    public static final String STATUTORY_AUTORITY = "StatutoryAutority";
    ...
    public static final String RECORDS_STATUS = "RecordsStatus";
