...
import no.novari.fint.sikri.data.noark.codes.dokumentstatus.DokumentstatusService;
import no.novari.fint.sikri.data.noark.codes.dokumenttype.DokumenttypeService;
import no.novari.fint.sikri.data.noark.codes.format.FormatService;
import no.novari.fint.sikri.data.noark.codes.journalposttype.JournalpostTypeService;
import no.novari.fint.sikri.data.noark.codes.journalstatus.JournalStatusService;
import no.novari.fint.sikri.data.noark.codes.korrespondanseparttype.KorrespondansepartTypeService;
import no.novari.fint.sikri.data.noark.codes.merknadstype.MerknadstypeService;
import no.novari.fint.sikri.data.noark.codes.partrolle.PartRolleService;
import no.novari.fint.sikri.data.noark.codes.saksmappetype.SaksmappetypeService;
import no.novari.fint.sikri.data.noark.codes.saksstatus.SaksStatusService;
import no.novari.fint.sikri.data.noark.codes.skjermingshjemmel.SkjermingshjemmelService;
import no.novari.fint.sikri.data.noark.codes.tilgangsrestriksjon.TilgangsrestriksjonService;
import no.novari.fint.sikri.data.noark.codes.tilknyttetregistreringsom.TilknyttetRegistreringSomService;
import no.novari.fint.sikri.data.noark.codes.variantformat.VariantformatService;
import no.novari.fint.sikri.data.noark.klasse.KlassifikasjonssystemService;
