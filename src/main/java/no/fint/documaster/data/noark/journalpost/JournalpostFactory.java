package no.fint.documaster.data.noark.journalpost;

import lombok.extern.slf4j.Slf4j;
import no.documaster.model.QueryInput;
import no.documaster.model.Result__1;
import no.fint.documaster.data.noark.dokument.DokumentbeskrivelseFactory;
import no.fint.documaster.data.noark.dokument.DokumentbeskrivelseService;
import no.fint.documaster.data.noark.korrespondansepart.KorrespondanseService;
...
import static no.fint.documaster.data.utilities.FintUtils.validIdentifikator;
