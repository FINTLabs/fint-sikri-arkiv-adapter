package no.fint.documaster.handler.kulturminne;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.common.collect.ImmutableList;
import lombok.extern.slf4j.Slf4j;
import no.fint.documaster.data.exception.NotTilskuddfartoyException;
import no.fint.documaster.data.kulturminne.TilskuddFartoyDefaults;
import no.fint.documaster.data.kulturminne.TilskuddFartoyService;
import no.fint.documaster.handler.Handler;
import no.fint.documaster.service.ValidationService;
